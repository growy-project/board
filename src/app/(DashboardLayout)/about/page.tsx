...
const AboutPage = () => {
  return (
    <PageContainer title="About" description="About Growy">
      <DashboardCard title="About Growy">
        <Box>
          <Typography variant="body1" sx={{ mb: 2, fontSize: "1.1rem" }}>
            Growy is built around one of the most widely used investing
          ...
          <Typography variant="body1" sx={{ fontSize: "1.1rem" }}>
            Growy doesn&apos;t try to tell you what to buy. Instead, it brings
            ...
            tools, plus insights and rankings from other users, Growy helps you
